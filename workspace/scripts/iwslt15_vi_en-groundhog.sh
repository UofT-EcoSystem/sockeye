...
CONFERENCE_SRC_TGT_MODEL_OPT=${CONFERENCE_SRC_TGT}-groundhog-${USE_MLP_ATT_SCORING_FUNC}${USE_LSTM_NONLINEAR_BLOCK}${USE_PAR_SEQUENCE_REVERSE}
...
python3 -m sockeye.train --source ${SOCKEYE_ROOT}/workspace/data/${CONFERENCE_SRC_TGT}/train-preproc.vi \
                         ...
                         --encoder=rnn --decoder=rnn --num-layers=2:2 --rnn-cell-type=lstm --rnn-num-hidden=1000 \
