...
plt_default_vs_econmt_full_training_validation_bleu('N', True, first_k_ckpts=(8, 6), discard=(4, 3))
plt_default_vs_econmt_full_training_validation_bleu('T', True, first_k_ckpts=(8, 6), discard=(4, 3))
