...
plt_default_vs_econmt_full_training_perplexity('N', prefix='iwslt15-vi_en-tbd-', suffix='-turing')
plt_default_vs_econmt_full_training_perplexity('T', prefix='iwslt15-vi_en-tbd-', suffix='-turing')
plt_default_vs_econmt_full_training_validation_bleu('T', first_k_ckpts=(7, 7, 7, 7, 6), bar=22.6,
                                                    prefix='iwslt15-vi_en-tbd-', suffix='-turing')
